import "./guardian-eye-icons.js?v=1.0.2-rc2";
import "./guardian-eye-camera-card.js?v=1.0.2-rc2";
import "./guardian-eye-nvr-card.js?v=1.0.2-rc2";
import {
...
import {
  ...
  nvrConfig,
} from "./guardian-eye-dashboard-config.js?v=1.0.2-rc2";
